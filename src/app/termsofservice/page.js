      ...
      <div className="lg:w-[85%] md:w-[90%] w-full border-x border-stone-300">
        <div className="prose lg:prose-xl md:prose-lg prose-base lg:px-8 px-4 py-8">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                [___COMPANY_INFORMATION___].
              </p>
            </li>
            <li>
              <p>
                <strong>&quot;Country&quot;</strong> refers to [___COMPANY_COUNTRY___].
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                &quot;Terms of Service&quot;) mean these Terms of Service that form the
            ...
            <li>
              <p>
                <strong>&quot;Website&quot;</strong> refers to [___WEBSITE_NAME___],
                accessible from [___WEBSITE_URL___]
              </p>
            </li>
            <li>
              <p>
          ...
          <p>
            ...
            ([___COPYRIGHT_AGENT_CONTACT_EMAIL___]) and include in Your notice a
